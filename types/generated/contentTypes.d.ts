...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  collectionName: 'case-studys';
  info: {
    displayName: 'Case Study';
    pluralName: 'case-studys';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fullChallenge: Schema.Attribute.Text;
    fullSolution: Schema.Attribute.Text;
    iconName: Schema.Attribute.String;
    image: Schema.Attribute.String;
...
export interface ApiCompanyPageCompanyPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bentoBadge: Schema.Attribute.String;
    bentoImages: Schema.Attribute.JSON;
    bentoTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroDescription: Schema.Attribute.Text;
    heroHeadlineHighlighted: Schema.Attribute.String;
    heroHeadlinePrefix: Schema.Attribute.String;
    heroHeadlineSuffix: Schema.Attribute.String;
    ...
    missionIconName: Schema.Attribute.String;
    missionTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    teamBadge: Schema.Attribute.String;
    teamDesc: Schema.Attribute.Text;
    teamTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valuesBadge: Schema.Attribute.String;
    valuesList: Schema.Attribute.JSON;
    valuesTitle: Schema.Attribute.String;
    visionDesc: Schema.Attribute.Text;
    visionIconName: Schema.Attribute.String;
...
export interface ApiContactSectionContactSection
  extends Struct.SingleTypeSchema {
  collectionName: 'contact-sections';
  info: {
    displayName: 'Contact';
  ...
  attributes: {
    ...
    formTitleHighlighted: Schema.Attribute.String;
    formTitlePrefix: Schema.Attribute.String;
    headerHighlighted: Schema.Attribute.String;
    headerPrefix: Schema.Attribute.String;
    headerSuffix: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    submitButtonSuccess: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerLinks: Schema.Attribute.Component<'shared.menu-link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    targetRegions: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiIndustriesSectionIndustriesSection
  extends Struct.SingleTypeSchema {
  collectionName: 'industries-sections';
  info: {
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  collectionName: 'industrys';
  info: {
    displayName: 'Industry';
    pluralName: 'industrys';
...
export interface ApiProcessSectionProcessSection
  extends Struct.SingleTypeSchema {
  collectionName: 'process-sections';
  info: {
    displayName: 'Process';
    pluralName: 'process-sections';
    singularName: 'process-section';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::process-section.process-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiServicesSectionServicesSection
  extends Struct.SingleTypeSchema {
  collectionName: 'services-sections';
  info: {
...
export interface ApiTechCategoryTechCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'tech-categorys';
  info: {
    displayName: 'Tech Category';
    pluralName: 'tech-categorys';
  ...
  attributes: {
    ...
    bgAccent: Schema.Attribute.String;
    borderAccent: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiTechStackSectionTechStackSection
  extends Struct.SingleTypeSchema {
  collectionName: 'tech-stack-sections';
  info: {
    displayName: 'Tech Stack';
    pluralName: 'tech-stack-sections';
    singularName: 'tech-stack-section';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    ctaLabel: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    headerBlueHighlighted: Schema.Attribute.String;
    headerHighlighted: Schema.Attribute.String;
    headerPrefix: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tech-stack-section.tech-stack-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTestimonialsSectionTestimonialsSection
  extends Struct.SingleTypeSchema {
  collectionName: 'testimonials-sections';
  info: {
...
export interface ApiTrustSectionTrustSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    activeStatusLabel: Schema.Attribute.String;
    ...
    ctaLabel: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    directorImage: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    meetTeamCtaHref: Schema.Attribute.String;
    meetTeamCtaLabel: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    quote: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::process-section.process-section': ApiProcessSectionProcessSection;
      ...
      'api::tech-category.tech-category': ApiTechCategoryTechCategory;
